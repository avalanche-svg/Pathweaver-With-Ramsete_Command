...
RamseteCommand command = new RamseteCommand(trajectory, drive::getpose, new RamseteController(2, 0.7), drive.getFeedForward(), drive.getKinematics(), drive::getSpeeds, drive.getLeftPIDController(), drive.getRightPIDController(), drive::setOuput, drive);
return command;
